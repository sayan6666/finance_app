...
public class Bag_Model : MonoBehaviour
{
    ...
    public static void StocksSet()
    {
        ...
        GameObject.Find("Bag_Stock1").transform.GetChild(1).gameObject.GetComponent<TextMeshPro>().SetText(Main_Model.GreenTechSolutions.fields.amount.ToString()+" шт.");
        ...
        GameObject.Find("Bag_Stock3").transform.GetChild(1).gameObject.GetComponent<TextMeshPro>().SetText(Main_Model.ToxicGoldInc.fields.amount.ToString() + " шт.");
